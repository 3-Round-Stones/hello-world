...
That's useful, but not so interesting. Now let's see how Callimachus processes requests for other resources. The HelloClass is a Callimachus Class with an associated view template of helloworld.xhtml.
